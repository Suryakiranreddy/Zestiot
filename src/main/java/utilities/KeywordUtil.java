...
public class KeywordUtil extends Utility {
	 ...
	 * @return
	 */
	public static void launchToUrl(String url) {
	 ...
	 * @return
	 */
	public static boolean clickJSElm(WebElement elm) {
		KeywordUtil.lastAction = "Click : " + elm.toString();
		LogUtil.infoLog(KeywordUtil.class, KeywordUtil.lastAction);
		Object obj = ((JavascriptExecutor) getDriver()).executeScript("arguments[0].click();", elm);
		return obj == null;
	}
	// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	/*
	...
	public static void hoverElementUsingWebelement(WebElement element) throws InterruptedException {
		KeywordUtil.lastAction = "Hover Element: " + element.toString();
		LogUtil.infoLog(KeywordUtil.class, KeywordUtil.lastAction);
		Point p = element.getLocation();
		Actions builder = new Actions(getDriver());
		builder.moveToElement(element).build().perform();
	...
	public static void hoverandClickonElement(By locator) throws InterruptedException {
		KeywordUtil.lastAction = "Hover Element: " + locator.toString();
		LogUtil.infoLog(KeywordUtil.class, KeywordUtil.lastAction);
		WebElement element = waitForClickable(locator);
		Point p = element.getLocation();
	...
	public static void clickUsingAction(WebElement elm) throws InterruptedException {
