...
public class CustomSuiteRunner {
	...
	public static void suiteRunner() {
		 ...
		 * suites and their enabled tests
		 * =====================================================================
		 * PROCESS - 1 Get information from Automation Control Sheet file
		 * ---------------------------------------------------------------------
		 * 
		 * >>>Read Common settings from excel file >> 1. Application Type 2.
		 * Environment(UAT,STAGING etc.) 3. Browser 4. Email output (Y/N) If Yes
		 * 4-1. Email ID comma separated list 4-2. HTML Report (Y/N) 4.3. XLS
		 * Report (Y/N) 4.4. Test Logs (Y/N)
		 * 
		 * 5. Defect management integration 6. Test management integration
		 * 
		 * >>> Go to Control Sheet Read Suite Name and Information 
		 * required to run suite -: 1. Suite Name (Only If it is Yes to run) 2.
		 * Suite Id (That is sheet name) 3. Browser Name 4. List of test cases
		 * that are enabled in Excel sheet
		 */

		// 1. Read Common settings from excel file
		GlobalUtil.setCommonSettings(ExcelDataUtil.getCommonSettings());
		//Write "In Progress" on Teststatus file
		WriteToFile.writetoFile("In Progress");
		...
		// Set Test Suites XMLs for execution
