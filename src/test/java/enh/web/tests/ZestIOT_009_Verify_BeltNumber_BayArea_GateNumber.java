...
public class ZestIOT_009_Verify_BeltNumber_BayArea_GateNumber extends KeywordUtil {
	String stepInfo = "";
	int retryCount = getIntValue("retryCount");
	static int retryingNumber = 1;


	@Test(testName = "ZestIOT_009_Verify_BeltNumber_BayArea_GateNumber", groups = {
			"Regression" }, description = "Verify BeltNumber BayArea GateNumber")
	public void test()
			throws Throwable {
		try {
			...
			DepartedFlights.Verify_BeltNumber_BayArea_GateNumber();
			HomePage.logOut();
