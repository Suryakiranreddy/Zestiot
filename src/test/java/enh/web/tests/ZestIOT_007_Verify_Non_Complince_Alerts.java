...
public class ZestIOT_007_Verify_Non_Complince_Alerts extends KeywordUtil {
	String stepInfo = "";
	...
	@Test(testName = "ZestIOT_006_VerifyFlightInfoAlerts", groups = {
			"Regression" }, description = "Verify Non Complince Alerts", dataProvider = "testData")
	public void test(String str_flightInfo, String str_type, String str_subType)
		...
		try {
			...
			Alerts.verifyNonComplianceAlerts();
			HomePage.logOut();
