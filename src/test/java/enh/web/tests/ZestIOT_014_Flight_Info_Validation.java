...
import enh.web.pages.NavigateToFlightInfo;
...
public class ZestIOT_014_Flight_Info_Validation extends KeywordUtil {
	String stepInfo = "";
	int retryCount = getIntValue("retryCount");
	static int retryingNumber = 1;


	@Test(testName = "ZestIOT_014_Verify_Flight_Info", groups = {
			"Regression" }, description = "Navigate to flightinfo : turn around list page and browse till the end of the page.")
	public void test()
			throws Throwable {
		try {
			...
			NavigateToFlightInfo.verifyFlightInfo();
			HomePage.logOut();
