...
public class ZestIOT_AV_2390_UI_CELEBI_Detect_totalNo_offlights_forwhich_finalCOBT_hashighOrless_difference_compareto_Actual_Offblock extends KeywordUtil {
	String stepInfo = "";
	int retryCount = getIntValue("retryCount");
	static int retryingNumber = 1;

	@Test(testName = "AV_2390_UI_CELEBI_Detect_totalNo_offlights_forwhich_finalCOBT_hashighOrless_difference_compareto_Actual_Offblock", groups = {
			"Regression" }, description = "Validate COBT and OffBlock time difference is more or less than 5min for CELEBI in UI")
	public void test()
			throws Throwable {
		try {
