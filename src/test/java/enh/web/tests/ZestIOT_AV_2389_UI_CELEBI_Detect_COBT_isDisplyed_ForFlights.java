...
public class ZestIOT_AV_2389_UI_CELEBI_Detect_COBT_isDisplyed_ForFlights extends KeywordUtil {
	String stepInfo = "";
	int retryCount = getIntValue("retryCount");
	static int retryingNumber = 1;

	@Test(testName = "AV_2389_UI_CELEBI_Detect_COBT_isDisplyed_ForFlights", groups = {
			"Regression" }, description = "Validate COBT is displayed for CELEBI in UI")
	public void test()
			throws Throwable {
		try {
