...
public class ZestIOT_023_FlightNumber_Arrival_FlightNumber_DepartureProdComparison extends KeywordUtil {
	String stepInfo = "";
	...
	public void test()
		...
		try {
			...
			FlightNumber_Arrival_FlightNumber_DepartureComparison.flightNumber_Arrival_FlightNumber_DepartureComparison();
