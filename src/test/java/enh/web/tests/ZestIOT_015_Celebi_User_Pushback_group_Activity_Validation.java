...
public class ZestIOT_015_Celebi_User_Pushback_group_Activity_Validation extends KeywordUtil {
	String stepInfo = "";
	int retryCount = getIntValue("retryCount");
	static int retryingNumber = 1;


	@Test(testName = "ZestIOT_015_Pushback_group_Activity_Validation", groups = {
			"Regression" }, description = "Verify group activities related to pushback")
	public void test()
			throws Throwable {
		try {
