...
public class ZestIOT_AV_2293_SG_HYD_Identify_coverage_of_Flight_Sensor_and_Validate_timestamps_of_Arrival_Aircrafts extends KeywordUtil {
	String stepInfo = "";
	int retryCount = getIntValue("retryCount");
	static int retryingNumber = 1;

	@Test(testName = "AV_2293_Identify_coverage_of_Flight_Sensor_and_Validate_timestamps_of_Arrival_Aircrafts", groups = {
			"Regression" }, description = "Identify coverage of Flight Sensor and Validate timestamps of Arrival Aircrafts for SG-Hyderabad")
	public void test()
			throws Throwable {
		try {
