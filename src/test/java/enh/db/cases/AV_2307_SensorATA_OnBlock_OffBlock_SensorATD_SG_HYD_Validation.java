...
public class AV_2307_SensorATA_OnBlock_OffBlock_SensorATD_SG_HYD_Validation{
	...
	public static void SensorATA_LessThanOnBlock_LessThanOffBlock_LessThanSensorATD_SG_HYD_Report(int operationunit, String airline) throws Exception{
		...
		+ "and operationunit= "+operationunit+" and flightnumber like '%"+airline+"%') and sensor_atd is not null");
				while (result8.next())
				{				
		...
		"and operationunit ="+operationunit+" and flightnumber like '%"+airline+"%') and (sensor_ata is not null and on_block_time is not null and off_block_time is not null and sensor_atd is not null)");
		while (result11.next()){	
