...
public class Scheduled_And_Sensor_ATA_Hyd {
	...
	public static void scheduledAndSensorATAForHyderabad() throws Exception{
		...
		ResultSet result4 = DBWrapper.Connect(SQL_Queries.strQuery_033);
		while (result4.next())
		{				
		...
		ResultSet result5 = DBWrapper.Connect(SQL_Queries.strQuery_034);
		while (result5.next())
		{				
		...
		ResultSet result6 = DBWrapper.Connect(SQL_Queries.strQuery_035);
		while (result6.next())
		{				
	...
	public static void scheduledAndSensorATAForHyderabad_Report() throws Exception {
		...
		email_report_Scheduled_And_Sensor_ATA_For_Hyd2.append("<table style=\"width:100%\" id=\"t01\"><caption> Total Flights LANDING (Not Detected by Flight Sensor but detected from other data source) </caption><tr><th style=\"width:10%\"><b>LogID</b></th>"
				...
				+ "<th style=\"width:15%\"><b>STA</b></th>"
		 		...
		 		+ " </tr>");
		ResultSet result31 = DBWrapper.Connect(SQL_Queries.strQuery_019);
		while (result31.next())
		{
		...
		email_report_Scheduled_And_Sensor_ATA_For_Hyd3.append("<table style=\"width:100%\" id=\"t01\"><caption> Total Flights - ONBLOCK (Not Detected by Flight Sensor but detected from other data source)</caption><tr>"
				...
				+ " </tr>");
		ResultSet result51 = DBWrapper.Connect(SQL_Queries.strQuery_034);
		while (result51.next())
		{				
		...
		ResultSet result61 = DBWrapper.Connect(SQL_Queries.strQuery_035);
		while (result61.next())
		{	
