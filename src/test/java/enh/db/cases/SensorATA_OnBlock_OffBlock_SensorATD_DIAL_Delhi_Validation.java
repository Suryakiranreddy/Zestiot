...
public class SensorATA_OnBlock_OffBlock_SensorATD_DIAL_Delhi_Validation{
	...
	public static StringBuilder email_report_SensorATA_OnBlock_OffBlock_SensorATD_For_DIAL_Delhi4 = new StringBuilder();
	public static StringBuilder email_report_SensorATA_OnBlock_OffBlock_SensorATD_For_DIAL_Delhi5 = new StringBuilder();
	...
	ResultSet result11 = DBWrapper.Connect("SELECT logid, flightnumber_departure, sensor_ata, on_block_time, Off_block_time, sensor_atd, (case when ((Sensor_ATA < On_Block_Time AND Sensor_ATA < Off_Block_Time) AND (Sensor_ATD > On_Block_Time AND Sensor_ATD > Off_Block_Time)) then 1 else 0 end) as Status\r\n" + 
		...
		email_report_SensorATA_OnBlock_OffBlock_SensorATD_For_DIAL_Delhi1.append("<h4 align=\"center\" style=\"color:#336600;\">Airport Name : DIAL-Delhi</h4>");
		email_report_SensorATA_OnBlock_OffBlock_SensorATD_For_DIAL_Delhi1.append("<h4 align=\"center\" style=\"color:#336600;\">Executed For :sensor-ATA, OnBlock, OffBlock, Sensor-ATD</h4><h5 align=\"center\" style=\"color:#336600;\" >Execution Time: "+SQL_Queries.todayDayDateTime()+" </h5>");
		...
		email_report_SensorATA_OnBlock_OffBlock_SensorATD_For_DIAL_Delhi2.append("<style>table#t01, th, td {border: 1px solid black;border-collapse: collapse;}table#t01 th{background-color:#80e5ff; color: white;} table#t01 tr:nth-child(even) {background-color: #f2f2f2;} table#t01 tr:nth-child(odd) { background-color: #DFEDEC;}table#t01 th, td {padding: 5px;}table#t01 th,td {text-align: center;} table#t01 caption {color: #336600;font-weight: bold;}</style>");
		...
		ResultSet result31 = DBWrapper.Connect("SELECT logid, flightnumber_arrival, on_block_time, off_block_time, sensor_atd FROM `DailyFlightSchedule_Merged` where\r\n" + 
				...
				"and (sensor_ata is null and on_block_time is not null and off_block_time is not null and sensor_atd is not null)");
							...
							email_report_SensorATA_OnBlock_OffBlock_SensorATD_For_DIAL_Delhi2.append(" <tr> <td><b style=\"color:red;\">"+str_LogID+"</b></td> <td><b style=\"color:red;\">"+str_flightNumber_Arrival+"</b></td>"
					...
					email_report_SensorATA_OnBlock_OffBlock_SensorATD_For_DIAL_Delhi2.append("<tr><td colspan=\"5\"><b style=\"color:red;\">No values found </b></td></tr>");	
					}
					...
					+ "where date(IFNULL(sta, eta))='"+SQL_Queries.yesterDate()+"' and operationunit= "+operationunit+") and on_block_time is null \r\n"
							+ "and (sensor_ata is not null and off_block_time is not null and sensor_atd is not null)");
										...
										{	
											...
											email_report_SensorATA_OnBlock_OffBlock_SensorATD_For_DIAL_Delhi3.append(" <tr> <td><b style=\"color:red;\">"+str_LogID+"</b></td> <td><b style=\"color:red;\">"+str_flightNumber_Arrival+"</b></td>"
											...
											email_report_SensorATA_OnBlock_OffBlock_SensorATD_For_DIAL_Delhi3.append("<tr><td colspan=\"5\"><b style=\"color:red;\">No values found </b></td></tr>");	
										}
			...
			ResultSet result71 = DBWrapper.Connect("SELECT logid, flightnumber_departure, sensor_ata, on_block_time, sensor_atd FROM `DailyFlightSchedule_Merged` where gmrpk_departure in (SELECT gmrpk FROM `DailyFlightScheduleDeparture_GMR` \r\n"
					...
					+ "and(sensor_ata is not null and on_block_time is not null and sensor_atd is not null)");
											...
											{	
												...
												email_report_SensorATA_OnBlock_OffBlock_SensorATD_For_DIAL_Delhi4.append(" <tr> <td><b style=\"color:red;\">"+str_LogID+"</b></td> <td><b style=\"color:red;\">"+str_flightNumber_Departure+"</b></td>"
									...
									{
									email_report_SensorATA_OnBlock_OffBlock_SensorATD_For_DIAL_Delhi4.append("<tr><td colspan=\"5\"><b style=\"color:red;\">No values found </b></td></tr>");	
									}
										email_report_SensorATA_OnBlock_OffBlock_SensorATD_For_DIAL_Delhi4.append("</table>");
			
						
			email_report_SensorATA_OnBlock_OffBlock_SensorATD_For_DIAL_Delhi5.append("<br><br>");
			email_report_SensorATA_OnBlock_OffBlock_SensorATD_For_DIAL_Delhi5.append("<style>table#t01, th, td {border: 1px solid black;border-collapse: collapse;}table#t01 th{background-color:#80e5ff; color: white;} table#t01 tr:nth-child(even) {background-color: #f2f2f2;} table#t01 tr:nth-child(odd) { background-color: #DFEDEC;}table#t01 th, td {padding: 5px;}table#t01 th,td {text-align: center;} table#t01 caption {color: #336600;font-weight: bold;}</style>");
			...
			ResultSet result91 = DBWrapper.Connect("SELECT logid, flightnumber_departure, sensor_ata, on_block_time, off_block_time FROM `DailyFlightSchedule_Merged` where \r\n" + 
					...
					"and (sensor_atd is null and on_block_time is not null and off_block_time is not null and sensor_ata is not null)");
									...
									email_report_SensorATA_OnBlock_OffBlock_SensorATD_For_DIAL_Delhi5.append(" <tr> <td><b style=\"color:red;\">"+str_LogID+"</b></td> <td><b style=\"color:red;\">"+str_flightNumber_Departure+"</b></td>"
									...
									{
									email_report_SensorATA_OnBlock_OffBlock_SensorATD_For_DIAL_Delhi5.append("<tr><td colspan=\"5\"><b style=\"color:red;\">No values found </b></td></tr>");	
									}
			...
			ResultSet result111 = DBWrapper.Connect("SELECT logid, flightnumber_departure, sensor_ata, on_block_time, Off_block_time, sensor_atd, (case when ((Sensor_ATA < On_Block_Time AND Sensor_ATA < Off_Block_Time) AND (Sensor_ATD > On_Block_Time AND Sensor_ATD > Off_Block_Time)) then 1 else 0 end) as Status\r\n" + 
				"FROM `DailyFlightSchedule_Merged` where gmrpk_departure in (SELECT gmrpk FROM `DailyFlightScheduleDeparture_GMR` where date(IFNULL(std, etd))='"+SQL_Queries.yesterDate()+"' \r\n" + 
					...
					while (result111.next()){	
						...
						if(str_status.contains("0")) {
							email_report_SensorATA_OnBlock_OffBlock_SensorATD_For_DIAL_Delhi6.append(" <tr> <td><b style=\"color:red;\">"+str_LogID+"</b></td> <td><b style=\"color:red;\">"+str_flight_NumberDeparture+"</b></td>"
								...
								HtmlReportUtil.test.log(LogStatus.INFO, email_report_SensorATA_OnBlock_OffBlock_SensorATD_For_DIAL_Delhi1.toString());
								HtmlReportUtil.testHist.log(LogStatus.INFO, email_report_SensorATA_OnBlock_OffBlock_SensorATD_For_DIAL_Delhi1.toString());
								...
								child0.log(LogStatus.INFO, "<b style=\"color:green;\" align=\"center\">Total Flights Scheduled for Arrival ("+SQL_Queries.yesterDate()+"): "+totalScheduledArrival+"</b>");			
								 ...
								 child3.log(LogStatus.INFO, email_report_SensorATA_OnBlock_OffBlock_SensorATD_For_DIAL_Delhi2.toString());
								 ...
								 child33.log(LogStatus.INFO, email_report_SensorATA_OnBlock_OffBlock_SensorATD_For_DIAL_Delhi2.toString());
								 ...
								 child5.log(LogStatus.INFO, email_report_SensorATA_OnBlock_OffBlock_SensorATD_For_DIAL_Delhi3.toString());
								 ...
								 child55.log(LogStatus.INFO, email_report_SensorATA_OnBlock_OffBlock_SensorATD_For_DIAL_Delhi3.toString());
								 ...
								 child7.log(LogStatus.INFO, email_report_SensorATA_OnBlock_OffBlock_SensorATD_For_DIAL_Delhi4.toString());
								 ...
								 child77.log(LogStatus.INFO, email_report_SensorATA_OnBlock_OffBlock_SensorATD_For_DIAL_Delhi4.toString());
								 ...
								 child9.log(LogStatus.INFO, email_report_SensorATA_OnBlock_OffBlock_SensorATD_For_DIAL_Delhi5.toString());
								 ...
								 child99.log(LogStatus.INFO, email_report_SensorATA_OnBlock_OffBlock_SensorATD_For_DIAL_Delhi5.toString());
								 ...
								 child111.log(LogStatus.INFO, email_report_SensorATA_OnBlock_OffBlock_SensorATD_For_DIAL_Delhi6.toString());
								 ...
								 child1111.log(LogStatus.INFO, email_report_SensorATA_OnBlock_OffBlock_SensorATD_For_DIAL_Delhi6.toString());
