	 ...
	 public static void cOBT_For_GMR_HYD_AISATS_User2() throws Exception{
		 String str_cobtDiff=null;
		  ...
		  Connection con = DriverManager.getConnection(
			...
			email_COBT_For_DIALCelebi_User5.append("<h4 align=\"center\" style=\"color:#336600;\">Executed For :COBT For GMR HYD AISATS</h4><h5 align=\"center\" style=\"color:#336600;\" >Execution Time: "+SQL_Queries.todayDayDateTime()+" </h5>");
